...
module.exports = function(chai, _) {
  ...
  Assertion.addProperty('trigger', function() {
    flag(this, 'trigger', true);
  });
  /**
  ...
  Assertion.addProperty('field', function() {
    ...
    if(type === 'input') {
      ...
      new Assertion(obj).to.have.property('label');
      new Assertion(obj.type).to.match(/^text|password|email|select|textarea|datetime|boolean$/);
