    ...
    if(type === 'input') {
      ...
      if(obj.type === 'select' || (obj.type === 'boolean' && obj.input_options)) {
        ...
        obj.input_options.forEach(function(input_option) {
          new Assertion(input_option, 'Input option should be an object').to.be.an('object');
          new Assertion(input_option, 'Input option needs a label string').to.have.property('label').a('string');
          new Assertion(input_option.label, 'Input option label should be a non-empty string').to.be.ok;
          new Assertion(input_option, 'Input option needs a value').to.have.property('value');
